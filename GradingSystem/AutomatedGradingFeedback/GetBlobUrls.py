...
def get_blob_urls_for_folder(StudyFiles: str, AssignmentFiles: str):
    ...
    # username = os.getenv('USER_NAME') # Not needed for trusted connection
    # password = os.getenv('PASSWORD') # Not needed for trusted connection
    database = os.getenv('DATABASE')

    # Establishing Connection with SQL Server using Windows Authentication (Trusted Connection)
